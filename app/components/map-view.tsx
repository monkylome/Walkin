      ...
      <APIProvider apiKey={API_KEY}>
        ...
        >
          ...
          {points.map((p) => {
            ...
            const dimmed = hasSelection ? !selected : outOfStock;
            return (
              <AdvancedMarker
                key={p.id}
                position={p.position}
              ...
              >
                {p.kind === "price" ? (
                  <PricePin price={p.price} selected={selected} dimmed={dimmed} />
                ) : (
                  <StorePin initials={p.initials} accentClass={p.accentClass} selected={selected} />
                )}
              </AdvancedMarker>
            );
          })}
